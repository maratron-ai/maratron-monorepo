export default function PrivacyPage() {
  return (
    <main className='w-full space-y-4 px-4 py-12 sm:px-6 lg:px-8'>
      <h1 className='text-3xl font-bold'>Privacy Policy</h1>
      <p>Last updated: July 09, 2025</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Maratron, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Maratron.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Maratron, accessible from{' '}
            <a
              href='maratron.ai'
      ...
      <ul>
        <li>
          <p>By email: j.thetford@rice.edu</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{' '}
            <a
              href='https://www.maratron.ai/contact'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://www.maratron.ai/contact
            </a>
          </p>
        </li>
      </ul>
